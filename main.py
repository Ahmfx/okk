...
def usernames():
    o = ''.join(choice("6") for i in range(1))
    t = ''.join(choice("qwertyuiopasdfghjklzxcvbnm") for i in range(1))
    d = ''.join(choice("5") for i in range(1))
    z = ''.join(choice("qwertyuiopasdfghjklzxcvbnm") for i in range(1))
    e = ''.join(choice("4") for i in range(1))
    i = ''.join(choice("3") for i in range(1)) 
    p = ''.join(choice("1") for i in range(1)) 
    x = ''.join(choice("2") for i in range(1)) 
    u1 = t + z + p + x + i + e 
    u2 = t + z + p + x + i + e + d
    u3 = t + z + p + x + i + e + d + o
    s = u1,u2,u3
